  ...
  return (
    <div className="size-full overflow-auto scrollbar-hide ">
      <div className="flex flex-col lg:flex-row">
        <div className="lg:w-[30%] w-[100vw] md:w-[100%] h-[95vh] lg:h-[1140px]  bg-[#AAAAAA] bg-[url(/img-about.png)] bg-[center_90px] lg:bg-[center_60%] bg-contain bg-no-repeat flex flex-col justify-between items-center lg:p-11">
          <div className="bg-black w-full text-center lg:text-left text-white text-4xl font-bold p-5 lg:p-3">
            NIKHIL SINGH
          </div>
        ...
        <div className="w-[100vw] md:w-[100%] lg:w-[70%] lg:h-[1140px] bg-[#222225]">
          <div className="p-10">
          ...
          <div className="flex flex-col gap-[2px] bg-[#3F3F46] shadow-xl/30">
            <div className="bg-[#1E1E21] p-10 flex flex-col justify-around lg:h-45 gap-6">
              <div className="text-xl text-white border-l-2 border-l-[#A4F025] pl-4 flex items-center">
                Back-End Development
              </div>
              <div className="width-full grid lg:grid-cols-3">
            ...
            <div className="bg-[#1E1E21] p-10 flex flex-col justify-around lg:h-50 gap-6">
              <div className="text-xl text-white border-l-2 border-l-[#A4F025] pl-4 flex items-center">
      ...
      <div className="bg-white w-full h-[95vh] lg:h-[55vh] flex flex-col lg:flex-row justify-around p-10">
        {careerDetails.map((section, idx) => (
          <div key={idx} className="lg:w-[40%] flex flex-col">
